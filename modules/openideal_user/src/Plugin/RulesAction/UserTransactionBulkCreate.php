 ...
 *
 * @RulesAction(
 *   id = "openideal_user_transaction_bulk_create",
 *   label = @Translation("Create a User points bulk transaction"),
 ...
 * )
 */
class UserTransactionBulkCreate extends RulesActionBase implements ContainerFactoryPluginInterface {
